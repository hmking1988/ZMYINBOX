 ...
 */
jQuery.sap.declare("accenture.com.ui.zmyinbox.util.Forward");

accenture.com.ui.zmyinbox.util.Forward = (function() {
	var _oXmlView = null;
		...
		open: function(fnStartSearch, fnCloseDlg, iNumberOfItems) {
			if (!_oXmlView) {
				_oXmlView = new sap.ui.view({
					id: 		"MIB_VIEW_FORWARD",
					viewName: 	"accenture.com.ui.zmyinbox.view.TaskList.Forward",
